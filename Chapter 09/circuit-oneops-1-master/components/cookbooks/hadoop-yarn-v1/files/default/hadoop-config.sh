...
TOOLS_LIB_JARS_DIR=${TOOLS_LIB_JARS_DIR:-"share/hadoop/tools/lib"}
...
if [ -d "$HADOOP_HDFS_HOME/$TOOLS_LIB_JARS_DIR" ]; then
  CLASSPATH=${CLASSPATH}:$HADOOP_HDFS_HOME/$TOOLS_LIB_JARS_DIR'/*'
fi
